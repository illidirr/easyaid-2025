...
# Для статических файлов (если еще нет):
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')
STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage'

# Добавьте в MIDDLEWARE после SecurityMiddleware:
'whitenoise.middleware.WhiteNoiseMiddleware',

# Настройки базы данных (в конец файла):
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Важно: ДОЛЖНО БЫТЬ НА 2 МЕСТЕ!
